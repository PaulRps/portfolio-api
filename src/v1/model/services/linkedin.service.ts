...
export class LinkedinService {
    ...
    async getEducation(): Promise<Education[]> {
        return [
            { name: 'Msc Computer Scienci', institution: { name: 'Universidade Federal da Paraíba', location: { country: 'Brazil' } }, beginAt: 'feb 2018', endAt: 'may 2020', description: 'I developed a Machine Learning model (Python, Keras and Tensorflow) based on Convolutional Neural Network to detect biometric features (singularities) from fingerprint images. Also, i developed desktop application (C# and Windows Form), Fingerprint-Label-Mark, to mark singularities on images and create ground truth databases with them.' },
            { name: 'Bachelor Computer Scienci', institution: { name: 'Universidade Federal da Paraíba', location: { country: 'Brazil' } }, beginAt: 'nov 2012', endAt: 'jun 2017', description: 'I have been member in the Programa de Educação Tutorial group for about 5 years, there i have  done teaching, researching and extras activities. Also, i have participated initiation scientific program and i have worked in digital image processing with fingerprint singularities extraction for 2 years.' },
        ]
    }
